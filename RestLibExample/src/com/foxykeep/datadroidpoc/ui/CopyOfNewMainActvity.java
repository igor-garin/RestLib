...
public class CopyOfNewMainActvity extends CopyOfBaseListActivity implements RequestListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mRequestHelper = new SingleRequestManagerActivityHelper<ThisService>(ThisService.class, this, savedInstanceState);
        ...
        mUserId = UserManager.getSecondUserId(this);

        String[] bindFrom = new String[] { "name",
                "manufacturer" };
        int[] bindTo = new int[] { R.id.tv_name, R.id.tv_manufacturer };
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(this,
                R.layout.crud_phone_list_item, 
                PH.from(this).query(Phone.class, null, null, null, null),
                bindFrom, bindTo);
