...
public abstract class BaseListActivity extends ListActivity implements
	...
	protected long mPhoneToAddUpdate;

	protected abstract Phone getPhoneOnPosition(int position);

	protected abstract void callSyncPhoneEditWS(long phone);

	protected abstract void callSyncPhoneAddWS(long phone);
	...
	protected void onActivityResult(final int requestCode,
		...
		case ACTIVITY_FOR_RESULT_ADD: {
			if (data != null) {
				mPhoneToAddUpdate = data
						.getLongExtra(CrudSyncPhoneAddEditActivity.INTENT_EXTRA_PHONE, mPhoneToAddUpdate);
