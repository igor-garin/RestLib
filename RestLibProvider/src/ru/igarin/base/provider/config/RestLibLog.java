package ru.igarin.base.provider.config;
...
public final class RestLibLog {
	...
	public static class LogConfig {
		 ...
		 */
		public static final int DP_LOG_LEVEL = Config.DP_LOG_LEVEL;
	...
	private static String getLocation() {
		final String className = RestLibLog.class.getName();
