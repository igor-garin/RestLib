...
package ru.igarin.base.service.network;
...
import ru.igarin.base.service.network.internal.NetworkConnectionImpl;
...
public final class NetworkConnection {
    ...
    public NetworkConnection(Context context, String url) {
        if (url == null) {
            RestLibLog.e("NetworkConnection.NetworkConnection - request URL cannot be null.");
